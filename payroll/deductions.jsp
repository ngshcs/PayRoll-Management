	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function()
			{
				...
				$("#dialog").dialog({autoOpen: false},{title: 'Add New Deduction'},{hide: 'slide'},{width:600},
						{closeOnEscape: true},{ resizable: false},{modal: true},{show: 'slide'});

				$("#dialog1").dialog({autoOpen: false},{title: 'Edit Deduction'},{hide: 'slide'},{width:600},
						{closeOnEscape: true},{ resizable: false},{modal: true},{show: 'slide'});
				...
				$("table.tablesorter td img.edit").click(function()
				{
					...
					$("#dialog1").dialog("open");
					document.getElementById("editDeduction").disabled = false;
				});
				...
				$("#editDeduction").click(function()
				{
					...
					document.getElementById("editDeduction").disabled = true;
					document.getElementById("editDeduction").value = "  Wait...  ";

					this.timer = setTimeout(function()
					{
					         $.ajax({
						url: 'editDeduction.jsp',
						...
						success: function(msg)
						{
							...
							document.getElementById("editDeduction").disabled = false;
							document.getElementById("editDeduction").value = "   Update   ";
						}
					        });
					}, 200);
				...
				$("#add").click(function()
				{
					...
					document.getElementById("addDeduction").disabled = false;
				});
				...
				$("#addDeduction").click(function()
				{
					...
					document.getElementById("addDeduction").disabled = true;
					document.getElementById("addDeduction").value = "  Wait...  ";

					this.timer = setTimeout(function()
					{
					         $.ajax({
						url: 'addDeduction.jsp',
						...
						success: function(msg)
						{
							...
							$("#dialog").dialog("close");
							document.getElementById("addDeduction").disabled = false;
							document.getElementById("addDeduction").value = "   Add   ";
						}
					        });
					}, 200);
					...
					return false;
	                   ...
	                   <script type="text/javascript">
	                            if(top.frames.length == 0)
	                                       top.location.href = "./home.jsp?deductions.jsp";
	                   </script>
	</head>
...
<%
		if( "admin".equals(type) )
		{
			...
			ResultSet rs = stmt.executeQuery("select * from Deduction order by id");
			int sno = 0;
%>
			<br /> <br />
			<table cellspacing="1" class="tablesorter">
				<thead> <tr>
					...
					<th align="center" class="header"> Deduction </th>
...
%>
			...
			<table align="right" border="0">
				<tr>
				        ...
				        <td id="add"> <font style="color:#DA4A38;cursor:pointer;"> <strong> Add New Deduction </strong> </font> </td>
				        <td> &nbsp; &nbsp; &nbsp; </td>
				</tr>
			</table>
				...
				<table align="center" style="font-size:17px;">
					...
					<tr>
						<td colspan="2" align="right">
							<input type="button" id="addDeduction" value="   Add   " disabled />
						</td>
					</tr>
				</table>
			</div>
			...
			<div id="dialog1">
				<table align="center" style="font-size:17px;">
					...
					<tr>
						<td colspan="2" align="right">
							<input type="button" id="editDeduction" value="   Update   " disabled />
						</td>
					</tr>
				</table>
			</div>
