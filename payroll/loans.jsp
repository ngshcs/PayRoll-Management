	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function()
			{
				...
				$("#dialog").dialog({autoOpen: false},{title: 'Add New Loan'},{hide: 'slide'},{width:600},
						{closeOnEscape: true},{ resizable: false},{modal: true},{show: 'slide'});

				$("#dialog1").dialog({autoOpen: false},{title: 'Edit Loan'},{hide: 'slide'},{width:600},
						{closeOnEscape: true},{ resizable: false},{modal: true},{show: 'slide'});
				...
				$("#editLoan").click(function()
				{
					...
					document.getElementById("editLoan").value = "  Wait...  ";
					...
					this.timer = setTimeout(function()
					{
						...
						success: function(msg)
						{
							...
							document.getElementById("editLoan").disabled = false;
							document.getElementById("editLoan").value = "   Update   ";
						}
					        });
					}, 200);
				...
				$("#addLoan").click(function()
				{
					...
					document.getElementById("addLoan").value = "  Wait...  ";
					...
					this.timer = setTimeout(function()
					{
						...
						success: function(msg)
						{
							...
							$("#dialog").dialog("close");
							document.getElementById("addLoan").disabled = false;
							document.getElementById("addLoan").value = "   Add   ";
						}
					        });
					}, 200);
					...
					return false;
	                   ...
	                   <script type="text/javascript">
	                            if(top.frames.length == 0)
	                                       top.location.href = "./home.jsp?loans.jsp";
	                   </script>
	</head>
...
<%
		if( "admin".equals(type) )
		{
			...
			ResultSet rs = stmt.executeQuery("select * from Loan order by id");
			int sno = 0;
%>
			<br /> <br />
			<table cellspacing="1" class="tablesorter">
				<thead> <tr>
					...
					<th align="center" class="header"> Loan </th>
...
%>
			...
			<table align="right" border="0">
				<tr>
				        ...
				        <td id="add"> <font style="color:#DA4A38;cursor:pointer;"> <strong> Add New Loan </strong> </font> </td>
				        <td> &nbsp; &nbsp; &nbsp; </td>
				</tr>
			</table>
				...
				<table align="center" style="font-size:17px;">
					...
					<tr>
						<td colspan="2" align="right">
							<input type="button" id="addLoan" value="   Add   " disabled />
						</td>
					</tr>
				</table>
			</div>
			...
			<div id="dialog1">
				<table align="center" style="font-size:17px;">
					...
					<tr>
						<td colspan="2" align="right">
							<input type="button" id="editLoan" value="   Update   " disabled />
						</td>
					</tr>
				</table>
			</div>
